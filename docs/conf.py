...
htmlhelp_basename = "Aiogoogledoc"
...
latex_documents = [
    (master_doc, "Aiogoogle.tex", "Aiogoogle Documentation", "Omar Ryhan", "manual")
]
...
man_pages = [(master_doc, "aiogoogle", "Aiogoogle Documentation", [author], 1)]
