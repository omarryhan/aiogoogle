# From: https://www.googleapis.com/discovery/v1/apis/oauth2/v2/rest

OAUTH2_V2_DISCVOCERY_DOC = {
    'auth': {'oauth2': {'scopes': {'https://www.googleapis.com/auth/plus.login': {'description': 'Know the list of people in your circles, your age range, and language'},
    ...
    'parameters': {'alt': {'default': 'json',
                    ...
                    'key': {'description': 'API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth '
                                        '2.0 token.',
                            'location': 'query',
                            'type': 'string'},
    ...
    'schemas': {'Jwk': {'id': 'Jwk',
                ...
                'Tokeninfo': {'id': 'Tokeninfo',
                            'properties': {'access_type': {'description': 'The access type granted with this token. It can be offline or online.', 'type': 'string'},
                                            'audience': {'description': 'Who is the intended audience for this token. In general the same as issued_to.', 'type': 'string'},
                                            'email': {'description': 'The email address of the user. Present only if the email scope is present in the request.', 'type': 'string'},
                                            ...
                                            'verified_email': {'description': 'Boolean flag which is true if the email address is verified. Present only if the email scope is '
                ...
                'Userinfoplus': {'id': 'Userinfoplus',
                                'properties': {'email': {'description': "The user's email address.", 'type': 'string'},
                                                ...
                                                'verified_email': {'default': 'true',
                                                                    'description': 'Boolean flag which is true if the email address is verified. Always verified because we only '
